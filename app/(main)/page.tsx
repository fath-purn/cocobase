...
import { SkeletonCard } from "../ui/admin/skeleton/card";
import ContactMe from "@/app/ui/contactme";
      ...
      >
        <div className="container mx-auto w-[90%] justify-between grid grid-cols-2 items-center">
          <div className="">
            ...
            <button className="bg-[#E37D2E] text-white px-6 py-3 rounded-lg shadow hover:bg-green-600 transition duration-300">
      ...
      >
        <div className="container mx-auto text-center">
          ...
          <Link
            href={"google.com"}
            target="blank"
            className="mt-3 bg-gray-50 text-gray-800 px-6 py-3 rounded-lg shadow hover:bg-gray-200 transition duration-300"
          >
            Beli Sekarang
          </Link>
        </div>
